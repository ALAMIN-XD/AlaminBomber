...
def update():
    ...
    try:
        parsedData = requests.get("https://raw.githubusercontent.com/atalamin/AlaminBomber/main/more/.version").json()
    except:
    ...
    if (toolVersion != mainVersion):
        ...
        os.system("cd .. && rm -rf AlaminBomber && git clone https://github.com/atalamin/AlaminBomber > /dev/null 2>&1")
        
        print("\033[37mDone")
        psb("    \033[92m[\033[37m*\033[92m] \033[37mStarting Tool...")
        time.sleep(0.8)
        
        os.system("cd .. && cd AlaminBomber && python Fuckbomb.py")
...
def logo():
    ...
    print("\033[94m│ \033[95mAuthor : Md. Alamin Islam                \033[94m│".center(columns+15))
    print("│ \033[95mTool   : Unlimited SMS Bomber          \033[94m│".center(columns+9))
    print("│ \033[95mGitHub : https://github.com/atalamin \033[94m│".center(columns+9))
    print("│ \033[95mCoder  : Md. Alamin Islam              \033[37mV4.0 \033[94m│".center(columns+15))
    print("\033[94m└────────────────────────────────────────┘".center(columns+5))
